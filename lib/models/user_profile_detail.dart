...
class UserProfileDetail {
  ...
  factory UserProfileDetail.fromMap(Map<String, dynamic> map) {
    return UserProfileDetail(
      ...
      lavelInfomation: map['lavelInfomation'] != null ? LavelInfomation.fromMap(map['lavelInfomation']) : null,
    );
  }

  String toJson() => json.encode(toMap());

  factory UserProfileDetail.fromJson(String source) => UserProfileDetail.fromMap(json.decode(source));
