class FriendModel {
  ...
  String? fixedCoins;
  String? imageDp;
  LavelInformation? lavelInformation;
  ...
  FriendModel.fromJson(Map<String, dynamic> json) {
    ...
    lavelInformation = json['lavelInformation'] != null
        ? new LavelInformation.fromJson(json['lavelInformation'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (lavelInformation != null) {
      data['lavelInformation'] = lavelInformation!.toJson();
    }
    return data;
  }
}

class LavelInformation {
  String? sandColor;
  String? sandBgImage;
  String? sendLevel;
  String? sendExp;
  ...
  LavelInformation.fromJson(Map<String, dynamic> json) {
