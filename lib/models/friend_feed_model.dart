class FriendFeedModel {
  ...
  FriendFeedModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['userId'];
    ...
    postLikeStatus = json['post_likeStatus'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['name'] = name;
    if (userImage != null) {
      data['userImage'] = userImage!.toJson();
    }
    data['postTime'] = postTime;
    data['post_likeStatus'] = postLikeStatus;
    data['commentBy'] = commentBy;
    data['comment'] = comment;
    data['commentByame'] = commentByame;
    data['commentByUsername'] = commentByUsername;
    return data;
  }
}
