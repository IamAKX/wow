...
class _MyCarsState extends State<MyCars> {
  ...
  getLuck() async {
    ...
    await apiCallProvider
        .postRequest(API.getPurchaseLuckyId, reqBody)
        .then((value) {
      if (value['details'] != null) {
        for (var item in value['details']) {
          list.add(PurchasedCarModel.fromJson(item));
        }
        setState(() {});
      }
    });
                ...
                InkWell(
                  onTap: () async {
                    Map<String, dynamic> reqBody = {
                      ...
                      'luckyId': list.elementAt(index).luckyId,
                    };

                    await apiCallProvider
                        .postRequest(API.applyLuckyId, reqBody)
                        .then((value) {
